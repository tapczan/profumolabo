...
<div class="page-heading">
	...
	<h2 class="blog-sub-heading text-center">{l s='Top Stories'}</h2>
	</div><!--.page-heading-->
{/block}
...
{block name='page_content'}
	...
	<div class="simpleblog__listing">
		<div class="{if $useMasonry}blog-masonry-list{else}row{/if}">
			...
			{$i++|truncate:0:""}
	        	{include file="themes/profumo-labo/modules/ph_simpleblog/views/templates/front/1.7/_partials/post-miniature.tpl" masonry=$useMasonry}
		    {/foreach}
	        {else}
