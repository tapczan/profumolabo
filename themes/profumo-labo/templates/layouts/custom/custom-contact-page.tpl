            ...
            <div class="contact-footer">
                <div class="row">
                    ...
                    <ul class="contact-social__list">
                        ...
                        <li><a href="#"><span class="contact-icon contact-icon--facebook"></span></a></li>
                        <li><a href="#"><span class="contact-icon contact-icon--instagram"></span></a></li>
                        <li><a href="#"><span class="contact-icon contact-icon--youtube"></span></a></li>
                        <li><a href="#"><span class="contact-icon contact-icon--twitter"></span></a></li>
                        <li><a href="#"><span class="contact-icon contact-icon--pinterest"></span></a>
                        </li>
                    </ul>
                    </div>
