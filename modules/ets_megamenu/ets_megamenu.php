...
class Ets_megamenu extends Module
{
    ...
    public function installDb()
    {
        ...
        return Db::getInstance()->execute("
                CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "ets_mm_block` (
                  ...
                  KEY `idx_id_column` (`id_column`, `sort_order`, `enabled`, `display_mnu_img`, `display_mnu_name`, `display_suppliers_img`, `display_suppliers_name`,`product_count`, `display_title`, `show_description`, `show_clock`) 
                )
            ")
            ...
            && Db::getInstance()->execute("
                CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "ets_mm_column` (
                  ...
                  KEY `idx_id_menu` (`id_menu`, `id_tab`, `is_breaker`, `sort_order`)
                )
            ")
            && Db::getInstance()->execute("
            ...
            && Db::getInstance()->execute("
                CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "ets_mm_menu` (
                  ...
                  PRIMARY KEY (`id_menu`),
                  KEY `idx_sort_order` (`sort_order`, `enabled`, `enabled_vertical`, `menu_open_new_tab`, `id_cms`, `id_manufacturer`, `id_supplier`, `id_category`, `menu_ver_alway_show`, `menu_ver_alway_open_first`, `menu_ver_hidden_border`, `display_tabs_in_full_width`)
                )
            ")
            && Db::getInstance()->execute("
            ...
            ") && Db::getInstance()->execute("
                CREATE TABLE IF NOT EXISTS `" . _DB_PREFIX_ . "ets_mm_tab` (
                  ...
                  `position_background` varchar(50) DEFAULT NULL,
                  PRIMARY KEY (`id_tab`),
                  KEY `idx_id_menu` (`id_menu`, `enabled`, `tab_sub_content_pos`, `id_category`, `id_cms`, `id_manufacturer`, `id_supplier`, `sort_order`)
                )
            ") && Db::getInstance()->execute("
    ...
    {
        $sqls = array();
        $sqls[] = 'ALTER TABLE `' . _DB_PREFIX_ . 'ets_mm_block` ADD INDEX (`id_column`, `sort_order`, `enabled`, `display_mnu_img`, `display_mnu_name`, `display_suppliers_img`, `display_suppliers_name`,`product_count`, `display_title`, `show_description`, `show_clock`) ';
        $sqls[] = 'ALTER TABLE `' . _DB_PREFIX_ . 'ets_mm_block_lang` ADD PRIMARY KEY (`id_block`, `id_lang`)';
        $sqls[] = 'ALTER TABLE `' . _DB_PREFIX_ . 'ets_mm_column` ADD INDEX (`id_menu`, `id_tab`, `is_breaker`, `sort_order`) ';
        $sqls[] = 'ALTER TABLE `' . _DB_PREFIX_ . 'ets_mm_menu` ADD INDEX (`sort_order`, `enabled`, `enabled_vertical`, `menu_open_new_tab`, `id_cms`, `id_manufacturer`, `id_supplier`, `id_category`, `menu_ver_alway_show`, `menu_ver_alway_open_first`, `menu_ver_hidden_border`, `display_tabs_in_full_width`)';
        ...
        $sqls[] = 'ALTER TABLE `' . _DB_PREFIX_ . 'ets_mm_tab` ADD UNIQUE (`id_menu`, `enabled`, `tab_sub_content_pos`, `id_category`, `id_cms`, `id_manufacturer`, `id_supplier`, `sort_order`)';
