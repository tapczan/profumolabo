...
class ArPLSameReferenceProducts extends ArPLListAbstract
{
    public $limit;
    public $more_link;
    public $more_url;
    ...
    public function getProductList()
    {
        ...
        $conditions = array(
            'p.reference = "' . $this->product->reference . '" AND p.id_product != ' . (int)$this->product->id
        );
    ...
    {
        return 'Same reference products';
    }
}
