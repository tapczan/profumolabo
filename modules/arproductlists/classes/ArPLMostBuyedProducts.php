...
class ArPLMostBuyedProducts extends ArPLListAbstract
{
    public $limit;
    public $days;
    public $more_link;
    ...
    public function getProducts($idLang)
    {
        ...
        $products = $this->getProducts2($id_lang, $id_shop, $this->limit, $conditions, $join, 'pv.orders', 'DESC', false, true, false);
