                                    ...
                                    if (Validate::$method($v)) {
                                        ...
                                        if ($addErrors) {
                                            if (isset($validator['message'])) {
                                                ...
                                                $this->addError($attr, sprintf($this->l('Incorrect "%s" value', 'ArPLModel'), $this->getAttributeLabel($attr)));
                                            }
                                        }
                                        $valid = false;
                                    }
            ...
            if ($this->getAttributeType($attr) == 'switch') {
                $config[$name]['values'] = array(
                    array(
                        'id' => 'active_on',
                        'value' => true,
                        'label' => $this->l('Enabled', 'ArPLModel'),
                    ),
                    array(
                        'id' => 'active_off',
                        'value' => false,
                        'label' => $this->l('Disabled', 'ArPLModel'),
                    )
                );
            }
