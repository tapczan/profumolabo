...
class ArPLPriceDrop extends ArPLListAbstract
{
    public $limit;
    public $loop;
    public $more_link;
    ...
    public function getProductList()
    {
        ...
        $products = Product::getPricesDrop($id_lang, 0, $this->limit, false, $this->orderBy == 'rand'? null : $this->orderBy, $this->orderBy == 'rand'? null : $this->orderWay);
        if ($this->instock) {
    ...
    public function getMoreLink()
    {
        ...
        return Context::getContext()->link->getPageLink('prices-drop');
    }
