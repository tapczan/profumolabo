...
{foreach $lists as $list}
    <div class="arpl-list-item active {if $list.product_context}arpl-list-item-product-context{/if}" data-product-context="{if $list.product_context}1{else}0{/if}" data-list-id="{$list.id_list|intval}">
        ...
        <div class="arpl-list-actions">
            <button class="arpl-list-action arpl-list-status" type="button">
            ...
            <button class="arpl-list-action arpl-list-device btn-dropdown" type="button">
                <span class="current">
