...
<li data-id="{$product->id|intval}" id="arpl-product-{$product->id|intval}">
    <div class="arpl-product-handle">
    ...
    <div class="arpl-product-name">{$product->name|escape:'htmlall':'UTF-8'}</div>
    <div class="arpl-product-ref">{$product->reference|escape:'htmlall':'UTF-8'}</div>
    <div class="arpl-product-price">{$price|escape:'htmlall':'UTF-8'}</div>
    <button class="arpl-product-delete" type="button">
