...
<li data-id="{$category->id|intval}" id="arpl-category-{$category->id|intval}">
    <div class="arpl-category-handle">
    ...
    <div class="arpl-category-name">{$category->name|escape:'htmlall':'UTF-8'}</div>
    <div class="arpl-category-ref">ID: {$category->id|intval}</div>
    <button class="arpl-category-delete" type="button">
