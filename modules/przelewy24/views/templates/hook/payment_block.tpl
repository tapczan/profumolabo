                    ...
                    {if $p24_paymethod_list_first|sizeof > 0}
                        {foreach $p24_paymethod_list_first as $bank_id => $bank_name}
                            {if !empty($bank_name)}
                                ...
                                {/if}
                                {if $showMethod === true}
                                    <a class="bank-box" {if in_array(($bank_id|intval), $card_ids) && $pay_card_inside_shop}onclick="showPayJsPopup()"{/if}
                                        data-id="{$bank_id}">
                            ...
                            {if !empty($bank_name)}
                                <li>
                                    <input type="radio" class="bank-box"
                                           {if in_array(($bank_id|intval), $card_ids) && $pay_card_inside_shop}onclick="showPayJsPopup()"{/if} data-id="{$bank_id}"
