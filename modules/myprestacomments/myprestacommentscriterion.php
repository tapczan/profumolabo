...
require_once(dirname(__FILE__).'/MyprestaCommentCriterion.php');

if (empty($_GET['id_lang']) === false &&
	isset($_GET['id_product']) === true)
{
	$criterions = MyprestaCommentCriterion::get($_GET['id_lang']);
	if ((int)($_GET['id_product']))
		$selects = MyprestaCommentCriterion::getByProduct($_GET['id_product'], $_GET['id_lang']);
