...
function upgrade_module_1_2_0(InPostShipping $module)
{
    ...
    $configuration = $module->getService('inpost.shipping.configuration.sending');
    /** @var Database $database */
    $database = $module->getService('inpost.shipping.install.database');
    /** @var Hooks $hooks */
    $hooks = $module->getService('inpost.shipping.install.hooks');
    ...
    return $configuration->setDefaults()
        ...
        && Db::getInstance()->execute('
            ...
            ADD `use_product_dimensions` TINYINT(1) UNSIGNED NOT NULL DEFAULT 0
        ');
}
