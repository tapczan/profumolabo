...
class SearchProvider implements FacetsRendererInterface, ProductSearchProviderInterface
{
    ...
    private function getAvailableSortOrders()
    {
        ...
        $sortGradeAsc = new SortOrder('product', 'grade', 'asc');
        $sortGradeDesc = new SortOrder('product', 'grade','desc');
        ...
        return [
            ...
            $sortGradeAsc->setLabel(
                $translator->trans('Grade, low to high', [],'Shop.Theme.Catalog')
            ),
            $sortGradeDesc->setLabel(
                $translator->trans('Grade, high to low', [],'Shop.Theme.Catalog')
            ),
        ];
    }
